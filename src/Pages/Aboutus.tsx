  ...
  return (
    ...
    <div className="aboutus">
      <div className="shortinfo">
        <p>
          Set in Tbilisi City, within 600 m from shopping centre City Mall, 6 km
          of Tbilisi Zoo and 8 km of Rustaveli Theatre, Boutique Hotel MOJO
      ...
      <div className="details">
        <div className="contact">
          <p>Contact Us</p>
          <address>Phone: +995322440405 </address>
          <address>Email: hotelmojo@gmail.com </address>
          <address>Location: Petre Kavtaradze 1 turn #7, Tbilisi, Georgia </address>
        </div>
        <div className="map">
          <p>Location</p>
          <iframe
